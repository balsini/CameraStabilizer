...
TM_MPU6050_Result_t TM_MPU6050_Init(TM_MPU6050_t* DataStruct, TM_MPU6050_Device_t DeviceNumber, TM_MPU6050_Accelerometer_t AccelerometerSensitivity, TM_MPU6050_Gyroscope_t GyroscopeSensitivity) {
	...
	/* Sample Rate Divider MPU6050 */
	TM_I2C_Write(MPU6050_I2C, DataStruct->Address, MPU6050_SMPLRT_DIV, 0x00);

	/* Low Pass Filter and Frame Synchronization MPU6050 */
	TM_I2C_Write(MPU6050_I2C, DataStruct->Address, MPU6050_CONFIG, 0x7);
